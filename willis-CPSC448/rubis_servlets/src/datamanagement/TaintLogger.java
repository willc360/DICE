...
public class TaintLogger {
	...
	private TaintLogger() {
		try {
			...
			FileHandler fhDB = new FileHandler("C:/Users/Sentinel/Desktop/taintlog/debbtaintlog.log");
			FileHandler fhTaint = new FileHandler("C:/Users/Sentinel/Desktop/taintlog/taintlog.log");
...
//			shTaint.setFormatter(new SimpleFormatter());
			...
			dlogger.setUseParentHandlers(false);
