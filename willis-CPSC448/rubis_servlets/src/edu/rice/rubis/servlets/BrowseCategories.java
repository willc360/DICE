    ...
    try
    {
     /* if (!rs.first())
        ...
        if (rs.next())
      {
        ...
        n = categoryName;
//        System.out.println(ReferenceMaster.getMap());
//        getname();
//        System.out.println(ReferenceMaster.getMap());
        randommethod();
//        String c=taintString("foo");
//        String a = randommethod(c); // not tainted
//        String b = randommethod(taintString("bar")); // tainted
...
//c not tainted here
        ...
        else
        {
          if (userId != -1)
            ...
            sp.printCategory(categoryName, 1); // WILLIS MOD
        }
      }
