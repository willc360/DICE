...
//	static {
//		try {
//			new AboutMe().doPost(null, null);
//			new AboutMe().doGet(null, null);
//		} catch (IOException e) {
...
//      stmt =
//        conn.prepareStatement(
//          "SELECT item_id, bids.max_bid FROM bids, items WHERE bids.user_id=? AND bids.item_id=items.id GROUP BY item_id");
//      stmt.setInt(1, userId.intValue());
