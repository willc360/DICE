...
public class ServletPrinter implements Serializable
{
    ...
    String callingServletName)
  {
    ...
    try
    {
      out = toWebServer.getWriter();//new remoting.PrintWriter(toWebServer.getWriter());
    }
    ...
    try
    {
          ...
          try
          {
            ...
            stmt =
              conn.prepareStatement(
                "SELECT id,qty,max_bid FROM bids WHERE item_id=? ORDER BY bid DESC");
      ...
      out.println(
        "<TR><TD>Quantity<TD><b><BIG>"
          ...
          + nbOfBids
          + "</BIG></b> (<a href=\"/rubis_servlets/edu.rice.rubis.servlets.ViewBidHistory?itemId="
          + itemId
          + "\">bid history</a>)\n"
          + "<TR><TD>Seller<TD><a href=\"/rubis_servlets/edu.rice.rubis.servlets.ViewUserInfo?userId="
          + sellerId
          + "\">"
          + sellerName
          + "</a> (<a href=\"/rubis_servlets/edu.rice.rubis.servlets.PutCommentAuth?to="
          + sellerId
          + "&itemId="
          + itemId
      ...
      if (buyNow > 0)
        out.println(
          "<p><a href=\"/rubis_servlets/edu.rice.rubis.servlets.BuyNowAuth?itemId="
            + itemId
            + "\">"
      ...
      {
        out.println(
          "<a href=\"/rubis_servlets/edu.rice.rubis.servlets.PutBidAuth?itemId="
            + itemId
      ...
      if (userId > 0)
      {
        ...
        printHTML(
          "<form action=\"/rubis_servlets/edu.rice.rubis.servlets.StoreBid\" method=POST>\n"
    ...
    String password)
  {
    ...
    {
      out.println(
        "<TR><TD><a href=\"/rubis_servlets/edu.rice.rubis.servlets.ViewItem?itemId="
          + itemId
          + "\">"
          + itemName
          + "<TD>"
          ...
          + "<TD>"
          + endDate
          + "<TD><a href=\"/rubis_servlets/edu.rice.rubis.servlets.ViewUserInfo?userId="
          + sellerId
          + "\">"
          + sellerName
          + "<TD><a href=\"/rubis_servlets/edu.rice.rubis.servlets.PutBid?itemId="
          + itemId
          + "&nickname="
          + username
          + "&password="
    ...
    try
    {
      out.println(
        "<TR><TD><a href=\"/rubis_servlets/edu.rice.rubis.servlets.ViewItem?itemId="
          ...
          + buyNow
          + "\n"
          + "<TD><a href=\"/rubis_servlets/edu.rice.rubis.beans.servlets.ViewUserInfo?userId="
          + sellerId
          + "\">"
          + sellerName
          + "</a>\n");
    ...
    int userId)
  {
    try
    {
      ...
      printHTML(
        "<form action=\"/rubis_servlets/edu.rice.rubis.servlets.StoreBuyNow\" method=POST>\n"
          + "<input type=hidden name=userId value="
          + userId
          + ">\n"
          + "<input type=hidden name=itemId value="
