...
import org.apache.aries.samples.ariestrader.persist.jdbc.TradeJdbc;
...
public class TradeServletAction {
    ...
    void doBuy(ServletContext ctx, HttpServletRequest req,
        ...
        try {
        	...
        	//OrderDataBean orderData = (OrderDataBean) RemotingManager.getInstance().downCall("http://localhost:8081/AriesWeb/Remoting", TradeJdbc.class.getMethod("buy", String.class, String.class, double.class, int.class), tradeServices, userID, symbol, new Double(quantity).doubleValue(), TradeConfig.orderProcessingMode);
